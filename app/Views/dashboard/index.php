<?= $this->extend('layout/template', $data); ?>
...
<div class="page-body">
    ...
    <div class="container-fluid dashboard-default-sec">
        ...
        <div class="row">
            <div class="col-md-4 box-col-6 des-xl-50">
                ...
                <div class="card income-card card-primary">
                    <div class="card-body text-center">
                        ...
                        <h5>Rp. <?= number_format($total_pokok['total'], 0, ",", ".")  ?></h5>
                        <p>Simpanan Pokok</p>
                        <div class="parrten">
            ...
            <div class="col-md-4 box-col-6 des-xl-10">
                ...
                <div class="card income-card card-primary">
                    <div class="card-body text-center">
                        ...
                        <h5>Rp. <?= number_format($total_simpanan['total'], 0, ",", ".")  ?></h5>
                        <p>Simpanan Wajib</p>
                        <div class="parrten">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 448.057 448.057" style="enable-background:new 0 0 448.057 448.057;" xml:space="preserve">
                                <g>
            ...
            <div class="col-md-4 box-col-6 des-xl-50">
                ...
                <div class="card income-card card-primary">
                    <div class="card-body text-center">
                        ...
                        <h5>Rp. <?= number_format($total_manasuka['total'], 0, ",", ".")  ?></h5>
