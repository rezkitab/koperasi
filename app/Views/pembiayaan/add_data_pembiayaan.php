            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Tambah Data Pembiayaan</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body pt-0">
                        <form action="<?= base_url('pembiayaan/create') ?>" method="POST">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-2 row">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="user_id" class="form-control form-control-sm select2" id="anggota" required>
                                                    <option value="" disabled selected>Pilih Anggota</option>
                                                    <?php foreach ($anggota as $list) {  ?>
                                                        <option value="<?= $list['id_user'] ?>" <?= set_select('user_id', $list['id_user']) ?>><?= $list['full_name'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
