            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body pt-0">
                        <form action="<?= base_url('pengurus/update/' . $pengurus['id']) ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control form-control-sm" name="nama_pengurus" value="<?= $pengurus['nama_pengurus'] ?>" placeholder="Nama Pengurus" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control form-control-sm" name="fakultas" value="<?= $pengurus['fakultas'] ?>" placeholder="Fakultas" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control form-control-sm" name="jabatan" value="<?= $pengurus['jabatan'] ?>" placeholder="Jabatan" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control form-control-sm" name="no_hp" value="<?= $pengurus['no_hp'] ?>" placeholder="No Hp" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control form-control-sm" name="email" value="<?= $pengurus['email'] ?>" placeholder="Email" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control form-control-sm" name="alamat" cols="30" rows="5"><?= $pengurus['alamat'] ?></textarea>
                                        ...
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="upload-button">
                                                    <input class="form-control" type="file" name="pengurus_image" />
                                                </div>
                                                <div class="upload-button pt-2 pl-2 pb-2">
                                                    <span class="badge bg-info text-white">kosongkan jika tidak ingin merubah gambar</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
